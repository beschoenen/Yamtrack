...
urlpatterns = [
    ...
    re_path(
        r"^media/(?P<media_type>[^/]+)/(?P<source>[^/]+)/(?P<media_id>\d+)/lists/(?P<list_id>\d+)/?$",
    ...
    re_path(
        r"^media/(?P<media_type>[^/]+)/(?P<source>[^/]+)/(?P<media_id>\d+)/(?P<season_number>\d+)/lists/(?P<list_id>\d+)/?$",
    ...
    re_path(
        r"^media/(?P<media_type>[^/]+)/(?P<source>[^/]+)/(?P<media_id>\d+)/(?P<season_number>\d+)/(?P<episode_number>\d+)/lists/(?P<list_id>\d+)/?$",
